...
export const PALETTE = {
  PRIMARY_BG: '#f7d5b4', // Cream
  SECONDARY_BG: '#ffffff', // White
  BOARD_LIGHT: '#e6b17e', // Gold / Sand
  BOARD_DARK: '#551e19', // Dark Brown
  HIGHLIGHT_OUTLINE: '#551e19', 
  PATH_INDICATOR: '#551e19',
  PRIMARY_TEXT: '#551e19',
  MUTED_ELEMENTS: '#e6b17e',
};
...
const WhiteRook = () => (
  <svg viewBox="0 0 45 45" className="w-full h-full">
    ...
    <g fill="none" stroke="#000" strokeLinecap="round">
      <line strokeWidth="1.2" x1="11" y1="14" x2="34" y2="14"/>
      <line strokeWidth="0.8" x1="14" y1="17" x2="31" y2="17"/>
      <line strokeWidth="0.8" x1="14" y1="29.5" x2="31" y2="29.5"/>
      <line strokeWidth="1.2" x1="12" y1="32" x2="33" y2="32"/>
    </g>
  </svg>
);
...
export const PIECE_ICONS: Record<PieceColor, Record<PieceType, React.ReactNode>> = {
  WHITE: {
    QUEEN: <WhiteQueen />,
    ROOK: <WhiteRook />,
    BISHOP: <WhiteBishop />,
